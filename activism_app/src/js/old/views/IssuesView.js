  ...
  render: function () {
    return (
      <div className="issueItem">
        <p className="issueItemScore">{this.props.supporters}</p>
          <span className="issueItemContent">
            <Link to={`/issue/${this.props.id}`}><h3>{this.props.title}</h3></Link>
              <p className="issueItemDescription">{this.props.description}</p>
            <span className="postedBy">Posted by {this.props.username} on {this.props.date_created}<br/>
            Tags: {this.props.tags}</span>
          </span>
        <hr/>
      </div>
    )
      ...
      <div className="userIssueFilter">
                <span>
                    <Link to={{ query: {sort:"top"} }}>
                      <Button bsSize="small" id="supporters" onClick={this.handleClick}>Top</Button>
                    </Link>
                    <Link to={{ query: {sort:"date-created"} }}>
                      <Button bsSize="small" id="date_created" onClick={this.handleClick}>Newest</Button>
                    </Link>
                </span>
      </div>
    );
